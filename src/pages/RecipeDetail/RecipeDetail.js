                            ...
                            <div className="col-12 col-lg-12 ml-5 mb-5">
                                <div className="ingredients">
                                    ...
                                    <div>
                                        ...
                                        >
                                            1 tablespoon butter, softened, or as needed, for
                                            greasing, plus more for serving
                                        </label>
                                    </div>
                                    <div>
                                        <span style={{ color: '#f39c12', fontSize: 25 }}> - </span>
                                        ...
                                        >
                                            toppings of choice, e.g. maple syrup or fruit, for
                                            serving
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-12 col-lg-12 ml-5">
                                ...
                                <div className="single-preparation-step d-flex">
                                    ...
                                    <p>
                                        ...
                                        mixture and whisk until just combined. (Batter will be
                                        lumpy.) Let rest 3 minutes and gently stir again.
                                    </p>
                                </div>
                                <div className="single-preparation-step d-flex">
                                    <h4>05.</h4>
                                    <p>
                                        ...
                                        paper towel. (You want just a bit of a sheen; don’t
                                        overgrease the griddle.) Spoon batter in 1/3-cup portions
                                        onto griddle. Cook until bubbles form on surface of batter,
                                        about 2 1/2 minutes.
                                    </p>
                                </div>
                                <div className="single-preparation-step d-flex">
                                    ...
                                    <p>
                                        ...
                                        about 1 1/2 minutes more. Repeat with remaining batter.
